    ...
    <>
      ...
      <style jsx>
        {`
          ...
          .sign-in11-title-root {
            display: flex;
            align-self: center;
            align-items: flex-start;
            flex-direction: column;
          }
          .sign-in11-have-an-account-login {
