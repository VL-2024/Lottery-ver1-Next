  ...
  return (
    <>
      ...
      >
                ...
                <Fragment>
                  <span className="fast-games-section-text4">
                    <span className="fast-games-section-text5">
                      Быстрые лотереи — моментальные результаты и шанс на
                      выигрыш в один клик.
                    </span>
        ...
        <Link href="/fast-games">
          <a className="fast-games-section-link">
...
`}
      ...
      <style jsx>
        {`
          ...
          .fast-games-section-text1 {
            font-size: 35px;
            font-style: normal;
            text-align: center;
            font-weight: 600;
          }
          .fast-games-section-text2 {
            width: 100%;
            font-size: 22px;
            font-style: normal;
            text-align: center;
          ...
          .fast-games-section-link {
            display: contents;
          }
          .fast-games-section-content2 {
          ...
          .fast-games-section-row-container1 {
            width: 100%;
            height: 200px;
            display: flex;
            align-items: stretch;
          ...
          .fast-games-section-strip1 {
            height: 180px;
            align-self: flex-start;
          }
          .fast-games-section-placeholder-image10 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image11 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image12 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image13 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image14 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image15 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-strip2 {
            height: 180px;
          }
          .fast-games-section-placeholder-image16 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image17 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image18 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image19 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image20 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image21 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-row-container2 {
            width: 100%;
            height: 200px;
            align-self: flex-start;
            margin-top: 0px;
          ...
          .fast-games-section-strip3 {
            height: 180px;
            align-self: flex-start;
          }
          .fast-games-section-placeholder-image22 {
            width: 300px;
            height: 168px;
            min-width: auto;
          }
          .fast-games-section-placeholder-image23 {
            width: 300px;
            height: 168px;
            min-width: auto;
          }
          .fast-games-section-placeholder-image24 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image25 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image26 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image27 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-strip4 {
            height: 180px;
          }
          .fast-games-section-placeholder-image28 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image29 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image30 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image31 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image32 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-placeholder-image33 {
            width: 300px;
            height: 168px;
          }
          .fast-games-section-container2 {
            display: contents;
          }
          .fast-games-section-text3 {
            display: inline-block;
          }
          .fast-games-section-text4 {
            display: inline-block;
            font-size: 22px;
            font-style: normal;
            font-weight: 400;
          }
          .fast-games-sectionroot-class-name {
            width: 100%;
          }
          ...
          @media (max-width: 479px) {
            ...
            .fast-games-section-text5 {
              font-style: inherit;
              font-weight: 400;
            }
            .fast-games-section-text6 {
              font-style: normal;
            }
          }
        `}
