    ...
    function validateRegisterForm() {
          ...
          <form id="registerForm" onsubmit="return validateRegisterForm()">
            <div id="registerFields">
              ...
              <label>
                {props.text12 ?? (
                  <Fragment>
                    <span className="form-reg-aut-text48">
                      Повторить пароль
                    </span>
                  </Fragment>
                )}
                ...
                {props.text14 ?? (
                  <Fragment>
                    <span className="form-reg-aut-text43">
                      Ссылка для восстановления пароля будет отправлена на
                      e-mail:
                      <span
      ...
      <style jsx>
        {`
          ...
          .form-reg-aut-container11 {
            width: 100%;
            align-self: center;
          }
          .form-reg-aut-container12 {
            display: contents;
          }
          .form-reg-aut-container13 {
            width: auto;
            height: auto;
            align-self: center;
          }
          .form-reg-aut-button6 {
            margin-top: 30px;
